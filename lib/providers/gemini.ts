...
export async function getStockSignals(
  ...
  const prompt = `You are a PSX Shariah-compliant swing trading analyst. Build today's ranked slate of 5-8 signals for short-term swing trades (days to 2 weeks). Return fewer than 5 only when fewer than 5 stocks are listed below.
